...
public class PresensiDataLapang extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener{

    private ListView listView;
    private String JSON_STRING;
    Button btnAbsen, btnKembali;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_data_presensi_lapang);
    ...
    private void showEmployee() {
        ...
        ListAdapter adapter = new SimpleAdapter(
                PresensiDataLapang.this, list, R.layout.listpresensi,
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(PresensiDataLapang.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.btnKembali){
            Intent intent = new Intent(PresensiDataLapang.this, BottomNavigator.class);
            startActivity(intent);
            finish();
        }else if(v.getId() == R.id.btnAbsen){
            Intent intent = new Intent(PresensiDataLapang.this, MapsActivity.class);
            startActivity(intent);
            finish();
        }
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(PresensiDataLapang.this, UDPresensiKarya.class);
